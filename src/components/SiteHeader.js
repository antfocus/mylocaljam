    ...
    >
      ...
      <div style={{
        ...
        <a href="/" aria-label="myLocalJam home" style={{ display: 'flex', alignItems: 'center' }}>
          {/* Mode-responsive wordmark — slate "myLocal" + orange "jam" on
              light bg, white "myLocal" + orange "jam" on dark bg. Replaces
              the v7 teal+orange treatment (May 5, 2026) for brand
              consistency with the OG card and the rest of the white-on-dark
              social system. The two PNGs were generated by recoloring the
              v7 source's teal pixels (~#1E5E60) to slate / white via PIL,
              preserving the custom typography. */}
          <Image
            src={darkMode ? '/myLocaljam_Logo_v8_white.png' : '/myLocaljam_Logo_v8_dark.png'}
            alt="myLocalJam"
            width={220}
            height={56}
            priority
